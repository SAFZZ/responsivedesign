...
<head>
    ...
    <title>SAFFZ Private Limited</title>
</head>

<body>
    <div class="jumbotron" >
        <div class="container text-center">
            <h1 class="display-3">SAFZZ Private Limited</h1>
    ...
    <div class="container">
        <div class="row align-items-end">
            <div class="col text-center">
                Copyright © 2021 SAFZZ Private Limited, Developed by Safzz
            </div>
        </div>
    </div>
    <!-- Optional JavaScript -->
...
{% block content %}
<div class="card">
  <img class="card-img-top" src="/static/img/office1.jpg" alt="Card image cap" height="700">
  <div class="card-body">
    <h5 class="card-title">About Us</h5>
    <p class="card-text">SAFZZ Private Limited, provides a broad range of semiconductor and infrastructure software applications that serve the data center, networking, software, broadband, wireless, and storage and industrial markets. Common applications for its products include: data center networking, home connectivity, broadband access, telecommunications equipment, smartphones, base stations, data center servers and storage, factory automation, power generation and alternative energy systems, displays, and mainframe operations and management, and application software development. Some of Silicon's core technologies and products include:
    <ul>
        <li>Memory Chips</li>
        <li>SATA HDD</li>
        <li>SATA SSD </li>
...
<div class="row text-center">
    ...
    <img class="card-img-top" src="/static/img/p1.png" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/p3.png" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/p5.png" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/p6.png" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/p7.png" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/p8.png" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/p9.png" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/p10.jpg" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/p11.png" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/p12.png" alt="Card image cap">
    <div class="card-body">
...
{% block content %}
    <div class="jumbotron">
        <div class="container text-center">
            ...
            <h5 class="display-6">The Legacy you know People you Don't </h5>
        </div>
    </div>
    <div class="row text-center">
        <div class="col-12">
    ...
    <div class="row text-center">
        <div class="card col-12 col-md-6 col-lg-3">
            <img class="card-img-top" src="/static/img/c10.png" alt="card image cap">
            <div class="card-body">
                <h5 class="card-title">CHA EUN WOO</h5>
                <p class="card-text">President</p>
                <a href="https://en.wikipedia.org/wiki/Cha_Eun-woo" class="btn btn-primary">More Details</a>
            </div>
        </div>
        <div class="card col-12 col-md-6 col-lg-3">
            <img class="card-img-top" src="/static/img/c2.png" alt="card image cap">
            <div class="card-body">
                <h5 class="card-title">HWANG IN YOUP</h5>
                <p class="card-text">Cheif Executive Officer</p>
                <a href="https://en.wikipedia.org/wiki/Hwang_In-youp" class="btn btn-primary">More Details</a>
            </div>
        </div>
        <div class="card col-12 col-md-6 col-lg-3">
            <img class="card-img-top" src="/static/img/c3.png" alt="card image cap">
            <div class="card-body">
                <h5 class="card-title">YANG YANG</h5>
                <p class="card-text">Cheif Operating Officer</p>
                <a href="https://mydramalist.com/people/5305-yang-yang" class="btn btn-primary">More Details</a>
            </div>
        </div>
        <div class="card col-12 col-md-6 col-lg-3">
            <img class="card-img-top" src="/static/img/c7.png" alt="card image cap">
            <div class="card-body">
                <h5 class="card-title">PARK HYUNG SIK</h5>
                <p class="card-text">Cheif Financial Officer </p>
                <a href="https://en.wikipedia.org/wiki/Park_Hyung-sik" class="btn btn-primary">More Details</a>
            </div>
        </div>
        <div class="card col-12 col-md-6 col-lg-3">
            <img class="card-img-top" src="/static/img/c5.png" alt="card image cap">
            <div class="card-body">
                <h5 class="card-title">LEE MIN HO</h5>
                <p class="card-text">Cheif Legal Officer</p>
                <a href="https://en.wikipedia.org/wiki/Lee_Min-ho_(actor)" class="btn btn-primary">More Details</a>
            </div>
        </div>
        <div class="card col-12 col-md-6 col-lg-3">
            <img class="card-img-top" src="/static/img/c6.png" alt="card image cap">
            <div class="card-body">
                <h5 class="card-title">KIM WOO BIN</h5>
                <p class="card-text">Cheif Marketing Officer</p>
                <a href="https://en.wikipedia.org/wiki/Lee_Min-ho_(actor)" class="btn btn-primary">More Details</a>
            </div>
        </div>
    </div>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <p class="card-text">
            <hr>
        <div class="col text-center">
            <h4 class="lead">Email: Safzz@gmail.com</h4><br>
            <h4 class="lead">Phone: +1-1594227</h4><br>
            <h4 class="lead">Address: © SAFZZ Private Limited,Mountain View, California, United-States</h4>
        </div>
        <hr>
    </div>
</div>
...
"http://safa.student.saveetha.in:8000/responsivehome/"